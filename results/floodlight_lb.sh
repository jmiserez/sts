...
curl -X POST -d '{"id":"1","address":"123.123.1.2","port":"8","pool_id":"1"}' http://localhost:8080/quantum/v1.0/members/
curl -X POST -d '{"id":"2","address":"123.123.1.3","port":"8","pool_id":"1"}' http://localhost:8080/quantum/v1.0/members/
